...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(self, map_name="8m", step_mul=8, move_amount=2, difficulty="7", game_version=None, seed=None,
                 ...
                 obs_timestep_number=False, state_last_action=True, state_timestep_number=False, reward_sparse=False,
                 reward_only_positive=True, reward_death_value=10, reward_win=200, reward_defeat=0,
                 reward_negative_scale=0.5, reward_scale=True, reward_scale_rate=20, replay_dir="", replay_prefix="",
    ...
    def get_obs_agent(self, agent_id) -> np.ndarray:
    ...
    def get_unit_type_id(self, unit, ally) -> int:
    ...
    def render(self, mode="human"):
        if self.renderer is None:
            from envs.smac_v1.official.render import StarCraft2Renderer
