...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(self, map_name="8m", step_mul=8, move_amount=2, difficulty="7", game_version=None, seed=None,
                 ...
                 obs_timestep_number=False, obs_own_pos=False, obs_starcraft=True, conic_fov=False, num_fov_actions=12,
                 ...
                 reward_scale_rate=20, kill_unit_step_mul=2, fully_observable=False, capability_config={},
