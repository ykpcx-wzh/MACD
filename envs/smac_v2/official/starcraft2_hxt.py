...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(self, map_name="8m", step_mul=8, move_amount=2, difficulty="7", game_version=None, seed=None,
                 ...
                 obs_timestep_number=False, obs_own_pos=False, obs_starcraft=True, conic_fov=False, num_fov_actions=4,
                 state_last_action=True, state_timestep_number=False, reward_sparse=False, reward_only_positive=True,
                 reward_death_value=10, reward_win=200, reward_defeat=0, reward_negative_scale=0.5, reward_scale=True,
                 reward_scale_rate=20, kill_unit_step_mul=2, fully_observable=False, capability_config=None,
                 replay_dir="", replay_prefix="", window_size_x=1920, window_size_y=1200, heuristic_ai=False,
                 heuristic_rest=False, debug=False):
        """
